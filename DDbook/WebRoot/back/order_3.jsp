...
<html>
  <head>
    ...
    <title>My JSP 'order_3.jsp' starting page</title>
            ...
            <tr>
                ...
                <td valign="top" background="/DDbook/images/content_bg.gif">
                    <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" background="/DDbook/images/content_bg.gif">
                        <tr><td height="31"><div class="title">已发货单</div></td></tr>
                    </table>
                </td>
                                            ...
                                            <form action="" method="">
                                                <table width="100%"  class="cont tr_color">
                                                    ...
                                                    <tr align="center" class="d">
                                                    	...
                                                    	<td><input type="button" value="详情" name="list" onclick="location.href='manager.do?method=showitem3&oid=${order.orderid}'"/></td>
